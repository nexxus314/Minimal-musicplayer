...
setSearchQuery(e.target.value)
  ...
  return (
    <div>
<header className="text-gray-600 body-font  bg-[d4a373]/30 rounded-4xl backdrop-blur-sm bg-[#368F8B]/30 mx-4 mt-4 fixed top-0 left-0 right-0 shadow-xl z-50 ">       
 <div className="w-full flex flex-row items-center justify-between px-6 sm:px-8 py-2 gap-2">
          <a className="flex title-font font-medium items-center text-gray-900 mb-4 py-0 md:mb-0" onClick={()=>{setShowList(false)}}>
            <span className="hidden sm:block lg:text-4xl font-[transcityDemo] text-lg md:text-sm whitespace-nowrap " >Basil</span>
